        ...
        listener: (context, state) {
          if (state is ShowAddTipState) {
            WidgetsBinding.instance.addPostFrameCallback(
              (timeStamp) {
                if (arg.requestData.paymentOpt != '2') {
                  showDialog(
                    context: context,
                    ...
                    builder: (_) {
                      ...
                      return AddTipWidget(
                        ...
                        currencySymbol:
                            arg.requestBillData.requestedCurrencySymbol,
                                                ...
                                                if (arg.requestData.isBidRide ==
                                                  ...
                                                  Column(
                                                    children: [
                                                      ...
                                                      if (requestBillData.cancellationFee != 0.0 &&
                                                          requestBillData
                                                                  .cancellationFee !=
                                                              0)
                                                        FareBreakup(
                              ...
                              child: Column(
                                children: [
                                  ...
                                  Container(
                                    ...
                                    child: (arg
                                            .driverData.profilePicture.isEmpty)
                                        ? const Icon(
                                            Icons.person,
                                            size: 50,
                                          )

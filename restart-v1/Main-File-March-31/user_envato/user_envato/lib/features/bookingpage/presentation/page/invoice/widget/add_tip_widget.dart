...
class AddTipWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<bool>(
        stream: rideRepository.paymentReceivedStream,
                                    ...
                                    children: [
                                      InkWell(
                                        ...
                                        child: Container(
                                          ...
                                          child: MyText(
                                              text:
                                                  '$currencySymbol $minimumTipAmount'),
                                        ),
                                      ),
                                      ...
                                      InkWell(
                                        ...
                                        child: Container(
                                          ...
                                          child: MyText(
                                              text:
                                                  '$currencySymbol ${double.parse(minimumTipAmount) * 2}'),
                                        ),
                                      ),
                                      SizedBox(width: size.width * 0.05),
                                      InkWell(
                                        ...
                                        child: Container(
                                          ...
                                          child: MyText(
                                              text:
                                                  '$currencySymbol ${double.parse(minimumTipAmount) * 3}'),
                                        ),
                                      ),
                                    ],
                                  ),

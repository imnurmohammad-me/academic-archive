                        ...
                        children: [
                                            ...
                                            (context
                                                ...
                                                : (context
                                                    ...
                                                    ? (context
                                                        ...
                                                        : MyText(
                                                            text: (context.read<BookingBloc>().requestData!.freeWaitingTimeInMinsBeforeTripStart ==
                                                                        0 ||
                                                                    context.read<BookingBloc>().requestData!.freeWaitingTimeInMinsAfterTripStart ==
                                                                        0)
                                                                ? AppLocalizations.of(
                                                                        context)!
                                                                    .waitingChargeText
                                                                ...
                                                                : AppLocalizations.of(
                                                                    ...
                                                                    .replaceAll(
                                                                        ...
                                                                        context.read<BookingBloc>().requestData!.isTripStart ==
                                                                                0
                                                                            ? context.read<BookingBloc>().requestData!.freeWaitingTimeInMinsBeforeTripStart.toString()
                                                                            : context.read<BookingBloc>().requestData!.freeWaitingTimeInMinsAfterTripStart.toString()),
                                                            textStyle: Theme.of(
                                                                    context)
                                                                .textTheme
                                                                .bodySmall!,
                          ...
                          if (context
                              ...
                              context
                                      ...
                                      .paymentType !=
                                  '2'
                              && context.read<BookingBloc>().requestData!.isDriverArrived == 1 &&
                              context.read<BookingBloc>().requestData!.isPaid ==0)
                            InkWell(
                              onTap: () {

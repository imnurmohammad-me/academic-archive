...
<template>
    <Layout>
        ...
        <PageHeader :title="$t('update')" :pageTitle="$t('complaint_title')" />
        <BRow>
            <BCol lg="12">
                    ...
                    <BCardBody class="border border-dashed border-end-0 border-start-0">
                        <form action="javascript:void(0);">
                            <div class="row">
                                <div class="col-6">
                                    <div class="mb-3">
                                    <label for="select_user_type" class="form-label">{{$t("user_type")}}ype</label>
                                    <select id="select__user_type" class="form-select" >
                                ...
                                <div class="col-6">
                                    <div class="mb-3">
                                    <label for="select_complaint_title_type" class="form-label">{{$t("complaint_title_type")}}</label>
                                    <select id="select_complaint_title_type" class="form-select" >
                                        <option disabled value="">{{$t("select")}}</option>
                                        <option  value="request_help">{{$t("request_help")}}</option>
                                        <option  value="app_setting">{{$t("general")}}</option>
                                    </select>
                                    <span v-for="(error, index) in errors.country" :key="index" class="text-danger">{{ error }}</span>
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="mb-3">
                                    <label for="complaint_type" class="form-label">{{$t("complaint_type")}}</label>
                                    <input type="text" class="form-control" placeholder="Enter Complaint Type" id="complaint_type" 
                                    />

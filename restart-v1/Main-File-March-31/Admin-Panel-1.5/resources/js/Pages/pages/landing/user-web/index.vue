    ...
    methods: {
      ...
      async sendOTP() {
        ...
        if (this.enable_firebase_otp) {
          ...
          try {
            const response = await axios.post('/api/v1/mobile-otp', { mobile: this.phoneNumber,country:this.selectedCountry.dial_code  });
    ...
    async verifyOTP() {
      ...
      async verifyFirebaseOTP() {
        ...
        try {
          ...
          console.error(t('error_verifying_firebase_otp'), error);
        }
      },

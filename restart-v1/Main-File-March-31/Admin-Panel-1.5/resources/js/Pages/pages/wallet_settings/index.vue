                    ...
                    <div class="mb-3" style="display: grid;place-items:center;">
                      ...
                      <div class="wallet"><div class="overlap">
                        ...
                        <div class="hstack gap-2 justify-content-center mt-4">
                            <button type="button" class="btn btn-light" style="border:1px solid #89478b">{{$t("cancel")}}</button>
                            <button type="button" class="btn" style="background-color: #89478b;color:white">{{$t("add_money")}}</button>
                        </div>
                      </div>
                    </div></div>
                    </div>
...
.wallet{
  width: 300px;
  height: 550px;
  background-image: url(/images/wallets.png);
